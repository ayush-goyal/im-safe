 ...
 *
 *  @discussion This property specifies the last known battery status of the flic. If the status is Unknown then it may take up to 24h before a correct value is calculated.
 *
 */
